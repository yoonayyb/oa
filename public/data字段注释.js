export default {
  ...
  "data": {
    ...
    "directorMaxLevel": 10, //审批主管最大层级
    "addressBookMaxLevel": 10, //通讯录最大主管层级
    "flowPermission": [], //发起人
    "nodeConfig": {
      "approve_man_id": 0, //修改模板id
      "beforManager": false, //找不到主管时 由上级审批
      "nodeName": "发起人", //节点名称
      "type": 0, // 0 发起人 1审批 2抄送 3条件 4路由
      "priorityLevel": "", // 条件优先级
      "approverType": "", // 审批类型 1人工审批 2自动通过 3自动拒绝
      "settype": "", // 审批人设置 1指定成员 2直属主管 3部门主管 4发起人自选 5发起人自己 6连续多级主管 7角色 8表单内的联系人
      ...
      "nodeUserList": [], //操作人
      "pointNodeUserList": [], //指定审批人
      "childNode": {
        "nodeName": "审核人",
        "error": false, //当前审批是否通过校验
        "type": 1,
        "approverType": 1, //默认人工审批
        "settype": 2,
        "selectMode": 0,
        "selectRange": 0,
        "directorLevel": 1,
