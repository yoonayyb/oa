  ...
  <Form v-bind="getBindValue" :class="getFormClass" ref="formElRef" :model="formModel"
    ...
    <Row v-bind="getRow">
      ...
      <template v-for="schema in getSchema" :key="schema.field">
        ...
        <FormItem :isAdvanced="fieldsIsAdvancedMap[schema.field]" :tableAction="tableAction"
          :formActionType="formActionType" :schema="schema" :formProps="getProps" :allDefaultValues="defaultValueRef"
          :formModel="formModel" :setFormModel="setFormModel">

          <template #[item]="data" v-for="item in Object.keys($slots)">
            <!-- 表单内联系人 -->
            <contactsSlot :formProps="getProps" @contactsChange="setFormModel" v-if="item === 'contactsOptions'"
              v-bind="data || {}">
            </contactsSlot>
...
<script lang="ts" setup>
  ...
  import contactsSlot from '@/components/Business/src/contactsSlot/index.vue';
  ...
  const emit = defineEmits(['contactsChange', 'advanced-change', 'reset', 'submit', 'register', 'field-value-change']);
