<template>
  <div>
    <Space>
      <a-button type="primary" @click="openUploadModal(true,{parent_id:props.parent_id})" preIcon="carbon:cloud-upload">
...
<script lang="ts" setup>
  ...
  const emit = defineEmits(['change', 'delete', 'preview-delete', 'update:value','reload']);
