<template>
  <a-modal title="选择成员" v-model:open="visibleDialog" :width="600" append-to-body class="promoter_person">
      <div class="person_body clear">
          <div class="person_tree l">
              <input type="text" placeholder="搜索成员" v-model="searchVal" @input="getDebounceData($event,activeName)">
              <a-tabs v-model:activeKey="activeName" @tab-change="handleClick">
                  <a-tab-pane tab="组织架构" key="1"></a-tab-pane>
                  <a-tab-pane tab="角色列表" key="2"></a-tab-pane>
              </a-tabs>
