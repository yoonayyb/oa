...
export const baseComponentCommonAttrs: Omit<IBaseFormAttrs, 'tag'>[] = [
  {
    ...
    includes: ['InputNumber', 'Input', 'Cascader', 'Button', 'VanInput'],
  },
  {
    name: 'placeholder',
    label: '占位符',
...
//vant组件属性
export const baseVantComponentAttrs: Omit<IBaseFormAttrs, 'tag'>[] = [
  {
    name: 'label',
    label: 'label文本',
    component: 'Input',
  ...
  },
  {
    ...
    includes: ['VanRadioGroup', 'VanCheckboxGroup'],
  },
  {
    name: 'shape',
    label: '自定义形状',
    ...
    includes: ['VanRadio', 'VanRadioGroup', 'VanCheckbox', 'VanCheckboxGroup'],
  },
  {
    name: 'content',
    label: '展示的文本',
    component: 'Input',
    includes: ['VanTextEllipsis'],
  },
  {
    name: 'rows',
    label: '展示的行数',
