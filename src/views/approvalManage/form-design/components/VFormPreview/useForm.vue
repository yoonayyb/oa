...
-->
<template>
  <Modal title="预览(不支持布局)" :open="state.visible" @ok="handleGetData" @cancel="handleCancel" okText="获取数据" cancelText="关闭"
    style="top: 20px" :destroyOnClose="true" :width="900">
    <BasicForm v-bind="attrs" :showActionButtonGroup='false' @register="registerForm" />
