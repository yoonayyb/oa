  ...
  setup(_, { attrs }) {
    ...
    function renderContent() {
      return (
        <>
          <SelectItem
            title={t('layout.setting.globalSize')}
            event={HandlerEnum.MENU_Global_Size}
            def={unref(getGlobalSize)}
            options={globalSizeOptions}
    ...
    return () => (
      ...
      >
        ...
        <Collapse v-model={activeKey} accordion>
          <CollapsePanel key="5" header={t('layout.setting.interfaceFunction')}>
            {/* <Divider>{() => t('layout.setting.interfaceFunction')}</Divider> */}
            {renderFeatures()}
          </CollapsePanel>
          <CollapsePanel key="6" header={t('layout.setting.interfaceDisplay')}>
            {/* <Divider>{() => t('layout.setting.interfaceDisplay')}</Divider> */}
            {renderContent()}
          </CollapsePanel>
          <CollapsePanel key="7" header={t('layout.setting.animation')}>
